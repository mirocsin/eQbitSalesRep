<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="fileupload.aspx.vb" Inherits="eService.fileupload" %>
...
<body>
<div id="fileupload">
    <form action="eService.asmx/uploadOffset" method="POST" enctype="multipart/form-data">
        <div class="fileupload-buttonbar">
            ...
            <input type="hidden" name="hidd_cucode" id="hidd_cucode" runat="server" />            
        </div>
    </form>
...
<script src="fileupload/jquery.tmpl.min.js"></script>
...
<script src="fileupload/application.js"></script>
</body> 
</html>
